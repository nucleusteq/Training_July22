...
/**
 * Annotation Practice class is used to create an object of Employee Details
 * class.
 * 
 * @author Sejal Jain
 * @version 0.1
...
public class AnnotationPractice {
    ...
    public static void main(String[] args) throws Exception {
        ...
        employeeDetails.setEmployeeName("SEjal Jain");
        employeeDetails.setDepartment("Engineering");
        employeeDetails.setEmailAddress("sejaljain@gmail.com");
        employeeDetails.setEmployeeId("1111");
