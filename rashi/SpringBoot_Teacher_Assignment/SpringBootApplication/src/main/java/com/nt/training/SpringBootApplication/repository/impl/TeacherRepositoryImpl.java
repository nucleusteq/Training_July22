...
public class TeacherRepositoryImpl implements TeacherRepository {
	...
	public TeacherRepositoryImpl() {
		...
		teachers.add(new Teacher(1,"Rashi","Jain","58965","Rashi.Jain@gmail.com"));
		teachers.add(new Teacher(2,"Parth","Waghela","91311","Parth.Waghela@gmail.com"));
		teachers.add(new Teacher(3,"Manav","Jindal","147852","Manav.Jindal@gmail.com"));
		teachers.add(new Teacher(4,"Sagar","Kalthiya","8881750","Sagar.kalthiya@gmail.com"));
}
