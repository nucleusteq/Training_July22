...
/**
 * Rotating an array class is used to rotate elements either towards right or left based on user preference 
 * @author ManavJindal
 *  @version 0.1
 *  @since 0.1
 */
...
/***
 * <p>The main method is used to give user a choice to select the direction of rotation. And to also specify the number of position it should rotate.</p>
 ...
 */
	public static void main(String[] args){
		...
		switch(option){
			...
			case 1:System.out.println("Rotate By: ");
				int d=sc.nextInt();
				rightRotate(array,d);
				break;
			case 2:System.out.println("Rotate By: ");
				int d1=sc.nextInt();
				leftRotate(array,d1);
				break;
			default:
