...
public class VendingMachineServiceImpl implements VendingMachineService {
	...
	public VendingMachineServiceImpl() {
		...
		list.add(new VendingMachine(2,"Lays",20,5));
		list.add(new VendingMachine(3,"Coke",30,2));
		list.add(new VendingMachine(4,"Cold coffee",40,4));
		...
		list.add(new VendingMachine(9,"Perk",90,9));
		list.add(new VendingMachine(10,"Biscuit",100,11));
