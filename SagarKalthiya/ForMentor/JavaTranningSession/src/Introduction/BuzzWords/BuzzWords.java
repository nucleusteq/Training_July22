package Introduction.BuzzWords;
/*
 * WHY JAVA IS:
​
1-Distributed:
...
​
4-Robust:
->There is automatic garbage collection in Java which runs on the Java Virtual Machine to eliminate objects which are not being accepted by a Java application anymore.
​
5-Portable:
